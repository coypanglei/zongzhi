 ...
 */
@ActivityScope
public class BusinessInterviewModel extends BaseModel implements BusinessInterviewContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public BusinessInterviewModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseBean<BusinessInterViewListBean>> getBusinessInterviewListData(int pageSize, int ignoreNumber) {
        ...
        return mRepositoryManager
                ...
                .getBusinessInterviewListData(SignUtil.paramSign(map));
    }
}