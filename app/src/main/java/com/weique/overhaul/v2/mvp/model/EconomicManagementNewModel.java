 ...
 */
@FragmentScope
public class EconomicManagementNewModel extends BaseModel implements EconomicManagementNewContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public EconomicManagementNewModel(IRepositoryManager repositoryManager) {
