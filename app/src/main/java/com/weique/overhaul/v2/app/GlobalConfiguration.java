...
import com.weique.overhaul.v2.mvp.model.api.SSLSocketClient;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        try {
            ...
            if (BuildConfig.DEBUG) {
                domain = AppUtils.getGlobalDomain(context);
            } else {
...
//                        okhttpBuilder.hostnameVerifier(SSLSocketClient.getHostnameVerifier()); //支持 Https, 详情请百度
                        okhttpBuilder.writeTimeout(25, TimeUnit.SECONDS);
