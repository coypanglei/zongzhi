...
public class OptionPopupRecyclerAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    public OptionPopupRecyclerAdapter(int layoutResId, @Nullable List<String> data, @Nullable List<Boolean> check, String type) {
