...
import static com.weique.overhaul.v2.mvp.ui.activity.visit.TourVisitActivity.IMAGE_ITEM_ADD;
        ...
        public void bind(int position) {
            ...
            try {
                ...
                if (isAdded && position == getItemCount() - 1) {
                    ...
                    if (item.path.contains("Uploads")) {
                        GlideUtil.loadImage(mContext, item.path, iv_img);
                    } else {
