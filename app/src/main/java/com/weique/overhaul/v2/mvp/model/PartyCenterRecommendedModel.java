 ...
 */
@FragmentScope
public class PartyCenterRecommendedModel extends BaseModel implements PartyCenterRecommendedContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PartyCenterRecommendedModel(IRepositoryManager repositoryManager) {
