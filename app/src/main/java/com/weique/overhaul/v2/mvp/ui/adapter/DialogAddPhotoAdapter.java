 ...
 * @author GreatKing
 */
public class DialogAddPhotoAdapter extends BaseQuickAdapter<InformationItemPictureBean, BaseViewHolder> {
    /**
     * 最大 图片数量 默认值是2  加上默认的添加图片
     */
    private int maxItem = 1;

    public DialogAddPhotoAdapter(List<InformationItemPictureBean> list) {
        super(R.layout.item_image_dialog, list);
    }
