...
import com.weique.overhaul.v2.mvp.ui.holder.helper.OnDragVHListener;
import com.weique.overhaul.v2.mvp.ui.holder.helper.OnItemMoveListener;

import java.util.List;

public class UserPreferenceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    // 我的频道 标题部分
    ...
    private List<HomeMenuItemBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public UserPreferenceAdapter(Context context, ItemTouchHelper helper, List<HomeMenuItemBean> mMyChannelItems, List<HomeMenuItemBean> mOtherChannelItems) {
        ...
        try {
            switch (viewType) {
                case TYPE_MY_CHANNEL_HEADER:
                    view = mInflater.inflate(R.layout.item_my_preference_header, parent, false);
                        ...
                        public void onClick(View v) {
                            try {
                                if (!isEditMode) {
                                    ...
                                    holder.tvBtnEdit.setText(R.string.edit_content);
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                ...
                case TYPE_MY:
                    view = mInflater.inflate(R.layout.home_grid_item, parent, false);
                ...
                case TYPE_OTHER:
                    view = mInflater.inflate(R.layout.home_grid_item_1, parent, false);
        ...
        try {
            if (holder instanceof MyViewHolder) {
                ...
                if (isEditMode) {
                    ...
                    headerHolder.tvBtnEdit.setText(R.string.edit_content);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        try {
            ...
            HomeMenuItemBean item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        try {
            ...
            HomeMenuItemBean item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        try {
            HomeMenuItemBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    private void startEditMode(RecyclerView parent) {
        try {
            ...
            for (int i = 0; i < visibleChildCount; i++) {
                ...
                ImageView imgEdit = (ImageView) view.findViewById(R.id.close_icon);
                if (imgEdit != null) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            imgEdit = (ImageView) itemView.findViewById(R.id.close_icon);
        }
