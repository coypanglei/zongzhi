 ...
 */
@FragmentScope
public class EconomicManagementNewPresenter extends ReworkBasePresenter<EconomicManagementNewContract.Model, EconomicManagementNewContract.View> {
    @Inject
    ...
    @Inject
    public EconomicManagementNewPresenter(EconomicManagementNewContract.Model model, EconomicManagementNewContract.View rootView) {
