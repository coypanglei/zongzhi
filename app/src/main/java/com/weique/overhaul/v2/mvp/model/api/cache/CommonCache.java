 ...
 */
package com.weique.overhaul.v2.mvp.model.api.cache;
...
public interface CommonCache {
 ...
 @LifeCache(duration = 2, timeUnit = TimeUnit.MINUTES)
    Observable<Reply<User>> getUser(Observable<User> users, DynamicKey idLastUserQueried, EvictProvider evictProvider);
}
