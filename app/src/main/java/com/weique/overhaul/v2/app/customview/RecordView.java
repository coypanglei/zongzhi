...
public class RecordView extends View {
     ...
     * 圆环颜色
     */
    private int[] doughnutColors = new int[]{0xFFBDF0FF, 0xFF45C3E5, 0xFF45C3E5, 0xFF45C3E5, 0xFF45C3E5};
    /**
     * 默认是录制模式
     */
    ...
    private void initAtts() {
        ...
        textHintSize = typedArray.getDimension(R.styleable.recordView_hintTextSize, 10);
    ...
    private void drawDefaultView(Canvas canvas) {
        ...
        paint1.setTextSize(dip2px(mContext, 14));
