 ...
 */
@FragmentScope
public class TaskAgentsModel extends BaseModel implements TaskAgentsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public TaskAgentsModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseBean<EventsReportedBean>> getTaskList(String name, int type, int pageSize, int ignoreNumber) {
