 ...
 */
@FragmentScope
public class AreaDetailsPresenter extends ReworkBasePresenter<AreaDetailsContract.Model, AreaDetailsContract.View> {
    @Inject
    ...
    @Inject
    public AreaDetailsPresenter(AreaDetailsContract.Model model, AreaDetailsContract.View rootView) {
    ...
    public void getAreaDetailsListData() {
        commonGetData(mModel.getAreaDetailsListData(pageSize, ignoreNumber), mErrorHandler, itemBean -> {
