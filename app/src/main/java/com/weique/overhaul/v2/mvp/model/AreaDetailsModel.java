 ...
 */
@FragmentScope
public class AreaDetailsModel extends BaseModel implements AreaDetailsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AreaDetailsModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseBean<List<AreaDetailsListBean>>> getAreaDetailsListData(int pageSize, int ignoreNumber) {
