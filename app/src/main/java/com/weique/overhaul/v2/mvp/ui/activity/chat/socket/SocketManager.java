package com.weique.overhaul.v2.mvp.ui.activity.chat.socket;
...
import com.weique.overhaul.v2.mvp.ui.activity.chat.voip.Utils;
import com.weique.overhaul.v2.mvp.ui.activity.chat.voip.VoipReceiver;
...
public class SocketManager implements IEvent {
    ...
    public void onInvite(String room, boolean audioOnly, String inviteId, String userList) {
        ...
        intent.setComponent(new ComponentName(AppManager.getAppManager().getmApplication().getPackageName(), VoipReceiver.class.getName()));
        // 发送广播
        AppManager.getAppManager().getmApplication().sendBroadcast(intent);
