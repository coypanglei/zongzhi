 ...
 * @author GreatKing
 */
public class NarrowDynamicFormAdapter extends BaseMultiItemQuickAdapter<InformationDynamicFormSelectBean.StructureInJsonBean, BaseViewHolder> {
     ...
     */
    public NarrowDynamicFormAdapter(List<InformationDynamicFormSelectBean.StructureInJsonBean> data) {
        super(data);
        //edittext 输入框
        addItemType(InformationDynamicFormSelectBean.SingleLineN, R.layout.narrow_dynamic_item_single_line);
        addItemType(InformationDynamicFormSelectBean.AutographN, R.layout.narrow_dynamic_item_single_line);
        addItemType(InformationDynamicFormSelectBean.MultiLineN, R.layout.narrow_dynamic_item_multi_line);
        addItemType(InformationDynamicFormSelectBean.NumberN, R.layout.narrow_dynamic_item_number);
        addItemType(InformationDynamicFormSelectBean.IdCardN, R.layout.dynamic_item_id_card);
        //图片用相同布局 设置最大数量进行控制
        addItemType(InformationDynamicFormSelectBean.SinglePicN, R.layout.narrow_dynamic_item_multi_pics);
        addItemType(InformationDynamicFormSelectBean.MultiPicsN, R.layout.narrow_dynamic_item_multi_pics);
        addItemType(InformationDynamicFormSelectBean.SingleVideoN, R.layout.narrow_dynamic_item_multi_pics);
        // 选择项全部用 popup 控制
        addItemType(InformationDynamicFormSelectBean.DateTimeN, R.layout.narrow_dynamic_item_popup);
        addItemType(InformationDynamicFormSelectBean.DropdownListN, R.layout.narrow_dynamic_item_popup);
        addItemType(InformationDynamicFormSelectBean.OptionN, R.layout.narrow_dynamic_item_popup);
        addItemType(InformationDynamicFormSelectBean.CheckBoxN, R.layout.narrow_dynamic_item_popup);
        gson = new Gson();
    }
                        ...
                        if (bean.getType() == InformationItemPictureBean.IS_DRAWABLE) {
                            ...
                            if (view.getId() == R.id.remove_image) {
                                ...
                                if (item.getIdentification().getType().equals(InformationDynamicFormSelectBean.SinglePic)) {
                                    item.setDefaultVal("");
                                    NarrowDynamicFormAdapter.this.notifyItemChanged(adapterPosition);
                                }
