...
package com.weique.overhaul.v2.app.baidu.clustering.view;
...
import com.weique.overhaul.v2.app.baidu.projection.Point;
import com.weique.overhaul.v2.app.baidu.projection.SphericalMercatorProjection;
import com.weique.overhaul.v2.app.baidu.ui.IconGenerator;
import com.weique.overhaul.v2.app.baidu.ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private static final int[] BUCKETS = {/*10, 20, 50,*/ 100, /*200,*/ 500, 1000, 5000, 10000, 50000, 100000};
...
//3.移除点
    ...
    private static Point findClosestCluster(List<Point> markers, Point point) {
        ...
        double minDistSquared = NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM
                * NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
        Point closest = null;
