 ...
 * @author GK
 */
public class AddressBookDetailAdapter extends BaseQuickAdapter<AddressBookItemBean.UsersBean, BaseViewHolder> {
    ...
    public AddressBookDetailAdapter() {
     ...
     */
    @Override
    protected void convert(@NonNull BaseViewHolder helper, AddressBookItemBean.UsersBean item) {
        try {
            View convertView = helper.itemView;
            ButterKnife.bind(this, convertView);
            GlideUtil.loadCircleImage(mContext, (item.getHeadUrl()), image);
            name.setText((item.getName()));
            address.setText(item.getDepartName());
