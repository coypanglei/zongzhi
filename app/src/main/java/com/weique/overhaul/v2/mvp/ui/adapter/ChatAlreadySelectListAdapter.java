 ...
 * @author GK
 */
public class ChatAlreadySelectListAdapter extends BaseQuickAdapter<AddressBookListBean.ListBean, BaseViewHolder> {
    ...
    public ChatAlreadySelectListAdapter() {
        super(R.layout.chat_item, new ArrayList<>());
    }
